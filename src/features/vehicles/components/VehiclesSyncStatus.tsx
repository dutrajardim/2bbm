...
/**
 * Displays a minimal sync status indicator for vehicles data.
 *
 * Shows time until the next check and includes a manual refresh button.
 *
 * @returns Minimal sync status component
 */
export const VehiclesSyncStatus = () => {
  const { timeUntilNextSync, isLoading, refreshSync } = useSyncStatus('vehicles')
