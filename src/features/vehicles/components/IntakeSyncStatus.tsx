...
import { useVehicleIntakesSyncStatus } from '../hooks/useVehicleIntakesSyncStatus'

/**
 * Displays a minimal sync status indicator.
 *
 * Shows when the last check occurred and time until the next check.
 * Includes a manual refresh button.
 *
 * @returns Minimal sync status component
 */
export const IntakeSyncStatus = () => {
  const { timeUntilNextSync, isLoading, refreshIntakes } = useVehicleIntakesSyncStatus()
